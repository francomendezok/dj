...
const musicFolder = "/mnt/c/Users/PCFRANCO/Music/2025/cuenca/Cumbia Extended";
...
async function processFile(fullPath, doneDir) {
  ...
  try {
    ...
    // Move to done folder with modified name
    const newFileName = `${nameWithoutExt} (Extended)${ext}`;
    const targetPath = path.join(doneDir, newFileName);
